        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" method="POST" action="update_penduduk_admin_action.php">
                        <div class="card-body">
                            <br>
							...
							<div class="form-group">
                                <label for="exampleInputId" class="input">Nomor Kartu Keluarga</label>
                                <input type="number" class="form-control input" id="exampleInputNama" required="" name="kk" value="<?php echo $data['kk']; ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputRt" class="input">TTL</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputStatus" class="input">Riwayat</label>
                                <select class="form-control input" id="sel1" name="riwayat" id="exampleInputGender">
                                    <option value="Hidup" <?php if ($data['riwayat']=='Hidup'){echo 'selected';}?> >Hidup</option>
                                    <option value="Meninggal" <?php if ($data['riwayat']=='Meninggal'){echo 'selected';}?> >Meninggal</option>
                                </select>
                            </div>
                        </div>
                        <!-- /.card-body -->
