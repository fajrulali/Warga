            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="input_admin.php">Input</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="tengah">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" method="POST" action="update_admin_action.php">
                        <div class="card-body">
                            <br>
                            <div class="form-group">
                                <label for="exampleInputId" class="input">Id Akun</label>
                                <input type="number" class="form-control input" id="exampleInputNama" required="" name="id_akun" value="<?php echo $data['id_akun']; ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputUsername" required="" name="username" value="<?php echo $data['username_akun']; ?>" readonly>
                            </div>
                            <div class="form-group">
